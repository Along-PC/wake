...
public class InviteCardWakeFragment extends BaseInviteFragment {
    private ImageView mImgInviteCardWake;
    ...
    public void initView(View view) {
        mImgInviteCardWake = (ImageView) view.findViewById(R.id.img_invite_card_wake);
        ...
        HttpUtils.getInstance().get(Constants.INVITE_CARD_DATA, map, new HttpCallback<InviteCardBean>() {
            ...
            public void onSuccessExecute(InviteCardBean inviteCardBean) {
                ...
                if ("true".equals(data)) {
                    ...
                    mDownloadUrl=data;
                    Glide.with(BaseApplication.mApplicationContext).load(data).placeholder(R.drawable.icon_invite_card_wake).into(mImgInviteCardWake);
                }
            }
        });
    }
    ...
    public int getRootView() {
        return R.layout.fragment_invite_card_wake;
    }
