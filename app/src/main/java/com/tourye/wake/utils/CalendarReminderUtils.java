...
/**
 * Created by longlongren on 2018/9/5.
 * <p>
 * introduce:日历添加行程工具类
 */
...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "wake";
    private static String CALENDARS_ACCOUNT_NAME = "BOOHEE@boohee.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.tourye.wake";
    private static String CALENDARS_DISPLAY_NAME = "WAKE账户";
    ...
    public static void addCalendarEvent(Context context, String title, String description, long reminderTime, int previousDate) {
        ...
        event.put(CalendarContract.Events.RRULE, "FREQ=DAILY;WKST=SU");//设置重复规则
