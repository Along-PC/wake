...
//                })
    ...
    public <T> void get(String url,Map<String,String> requestParams,HttpCallback<T> callback){
        ...
        if (!TextUtils.isEmpty(authorization)) {
            ...
            //        "Authorization","Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NjQxMTM4NDMsImlhdCI6MTUzMjU3Nzg0MywidWlkIjoiMTUyNDNWIn0.c7WE9m_MldGhqEWOEVxDHFVYOEsNdJfjmtoSm6BMC90"
    ...
    //get访问不需要验证token
    public <T> void getNoAuth(String url,Map<String,String> requestParams,HttpCallback<T> callback){
